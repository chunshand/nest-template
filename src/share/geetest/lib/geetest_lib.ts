...
const qs = require('qs');
import GeetestLibResult from "./geetest_lib_result"
export default class GeetestLib {
    static IS_DEBUG = false; // 调试开关，是否输出调试日志
     ...
     * 正常流程下（即验证初始化成功），二次验证
     */
    async successValidate(challenge: string, validate: string, seccode, params) {
